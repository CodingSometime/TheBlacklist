...
$(document).ready(function() {
  ...
  //   if (validateNationalIdentifier(this.value) == false) {
  //     $("#modalAlertMessage").html("เลขที่บัตรประจำตัวประชาชนไม่ถูกต้อง");
  ...
  // **************************************************************************
  // APIs Validation (Duplicate Checker)
  // **************************************************************************
  $("#nationalId").blur(function() {
    ...
    $.get(validateUrl, function(data) {
      ...
      $("#modalAlertMessage").html("เลขที่บัตรประจำตัวประชาชนนี้มีอยู่แล้วในระบบ");
      $("#modalAlert").modal("show");
      $("#modalAlert").on("hidden.bs.modal", function() {
        $("#nationalId").focus();
      });
