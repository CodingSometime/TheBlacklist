  ...
  <div class="table-responsive">
    <table class="table table-hover">
      <thead>
        <tr>
          <th>#</th>
          <th><?php echo @lang("STATUS_CODE"); ?></th>
          <th><?php echo @lang("STATUS_NAME_EN"); ?></th>
          <th><?php echo @lang("STATUS_NAME_TH"); ?></th>
      ...
      <tbody>
        ...
        ?>
            <tr <?php echo $inactiveCssName;?>>
              ...
              <td><?php echo @$rs->statusCode; ?></td>
              <td><?php echo @$rs->statusNameEn; ?></td>
              <td><?php echo @$rs->statusNameTh; ?></td>
              <td class="text-nowrap">
                ...
                <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#modalDeleteConfirm" data-bs-action="remove" data-bs-id="<?php echo @$rs->id; ?>" data-bs-label="<?php echo @$rs->statusNameEn; ?>"><?php echo @lang('LIST_BUTTON_DEL'); ?></button>
              </td>
            </tr>
        <?php
            $counter++;
