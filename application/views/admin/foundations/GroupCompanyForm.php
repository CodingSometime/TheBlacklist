...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-2 row">
      <label for="_GroupCode" class="col-sm-3 col-form-label"><?php echo @lang('GROUP_CODE'); ?></label>
    ...
    <div class="mb-2 row">
      <label for="_GroupName" class="col-sm-3 col-form-label"><?php echo @lang('GROUP_NAME'); ?></label>
      <div class="col-sm-4 has-validation">
