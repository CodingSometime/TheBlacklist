  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-2 row">
      ...
      <div class="col-sm-2 has-validation">
        <input type="text" class="form-control" id="_CountryCode" name="countryCode" style="text-transform:uppercase" value="<?php echo @$items->countryCode; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_CountryNameEn" class="col-sm-3 col-form-label"><?php echo @lang('COUNTRY_NAME_EN'); ?></label>
    ...
    <div class="mb-2 row">
      <label for="_CountryNameTh" class="col-sm-3 col-form-label"><?php echo @lang('COUNTRY_NAME_TH'); ?></label>
      <div class="col-sm-4 has-validation">
