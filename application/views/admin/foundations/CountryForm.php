...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    <?php echo form_open(base_url() . "page/country/save", array("id" => "formData", "class" => "row g-3 needs-validation")); ?>
    ...
    <div class="mb-2 row">
      <label for="_CountryCode" class="col-md-3 col-form-label"><?php echo @lang('COUNTRY_CODE'); ?></label>
      <div class="col-md-2 has-validation">
        <input type="text" class="form-control" id="_CountryCode" name="countryCode" onkeyup="this.value = this.value.toUpperCase();" value="<?php echo @$items->countryCode; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_CountryNameEn" class="col-md-3 col-form-label"><?php echo @lang('COUNTRY_NAME_EN'); ?></label>
      <div class="col-md-4 has-validation">
        <input type="text" class="form-control" id="_CountryNameEn" name="countryNameEn" value="<?php echo @$items->countryNameEn; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_CountryNameTh" class="col-md-3 col-form-label"><?php echo @lang('COUNTRY_NAME_TH'); ?></label>
      <div class="col-md-4 has-validation">
        <input type="text" class="form-control" id="_CountryNameTh" name="countryNameTh" value="<?php echo @$items->countryNameTh; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
...
<script>
  $(document).ready(function() {
    var baseUrl = "<?php echo base_url(); ?>page/country";
    ...
    $("#_CountryCode").keyup(function() {
      ...
      let countryCode = encodeURIComponent(this.value);
      let validateUrl = `${baseUrl}/validate/${formId}/${countryCode}`;
