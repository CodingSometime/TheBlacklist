...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-2 row">
      <label for="_AllegationCode" class="col-sm-3 col-form-label"><?php echo @lang('ALLEGATION_CODE'); ?></label>
      <div class="col-sm-4 has-validation">
        <input type="text" class="form-control" id="_AllegationCode" name="allegationCode" style="text-transform:uppercase" value="<?php echo @$items->allegationCode; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_AllegationType" class="col-sm-3 col-form-label"><?php echo @lang('ALLEGATION_TYPE'); ?></label>
      <div class="col-sm-4 has-validation">
        <input type="text" class="form-control" id="_AllegationType" name="allegationType" value="<?php echo @$items->allegationType; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_AllegationLevel" class="col-sm-3 col-form-label"><?php echo @lang('ALLEGATION_LEVEL'); ?></label>
      <div class="col-sm-4 has-validation">
