      ...
      <thead>
        <tr>
          <th>#</th>
					...
					<th><?php echo @lang("COUNTRY_NAME_EN");?></th>
					<th><?php echo @lang("COUNTRY_NAME_TH");?></th>
        ...
        ?>
            <tr>
              <td class="text-muted"><?php echo $counter; ?></td>
							...
							<td><?php echo @$rs->countryNameEn;?></td>
							<td><?php echo @$rs->countryNameTh;?></td>
              <td class="text-nowrap">
                ...
                <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#modalDeleteConfirm" data-bs-action="remove" data-bs-id="<?php echo @$rs->id; ?>" data-bs-label="<?php echo @$rs->countryCode; ?>"><?php echo @lang('LIST_BUTTON_DEL'); ?></button>
              </td>
            </tr>
        <?php
            $counter++;
