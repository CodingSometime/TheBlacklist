  ...
  <div class="table-responsive">
    <table class="table">
      <thead>
        <tr>
          <th>#</th>
					<th><?php echo @lang("TITLE_CODE");?></th>
					<th><?php echo @lang("TITLE_NAME_EN");?></th>
					<th><?php echo @lang("TITLE_NAME_TH");?></th>
        ...
        ?>
            <tr>
              <td class="text-muted"><?php echo $counter; ?></td>
							<td><?php echo @$rs->titleCode;?></td>
							<td><?php echo @$rs->titleNameEn;?></td>
							<td><?php echo @$rs->titleNameTh;?></td>
              <td class="text-nowrap">
                ...
                <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#modalDeleteConfirm" data-bs-action="remove" data-bs-id="<?php echo @$rs->id; ?>" data-bs-label="<?php echo @$rs->titleNameEn; ?>"><?php echo @lang('LIST_BUTTON_DEL'); ?></button>
              </td>
            </tr>
        <?php
            $counter++;
