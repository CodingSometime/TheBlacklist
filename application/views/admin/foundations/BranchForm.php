...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-2 row">
      <label for="branchCode" class="col-sm-3 col-form-label"><?php echo @lang('BRANCH_CODE'); ?></label>
      <div class="col-sm-4 has-validation">
        <input type="text" class="form-control" id="branchCode" name="branchCode" style="text-transform:uppercase" value="<?php echo @$items->branchCode; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_BranchName" class="col-sm-3 col-form-label"><?php echo @lang('BRANCH_NAME'); ?></label>
      <div class="col-sm-4 has-validation">
...
<script>
  $(document).ready(function() {
    ...
    $("#branchCode").keyup(function() {
      ...
      var branchCode = encodeURIComponent(this.value);
      var companyCode = $("#companyCode").val();
      var validateUrl = `${baseUrl}/validate/${formId}/${branchCode}/${companyCode}`;
    ...
    // **************************************************************************
    // !validate data ! company code
    // **************************************************************************
    $("#companyCode").change(function() {
      $("#error-message").text("");
      $("#buttonSubmit").attr("disabled", false);
      var companyCode = encodeURIComponent(this.value);
