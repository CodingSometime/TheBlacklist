...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-2 row">
      <label for="_TimeCode" class="col-sm-3 col-form-label"><?php echo @lang('TIME_CODE'); ?></label>
      <div class="col-sm-2 has-validation">
        <input type="text" class="form-control" id="_TimeCode" name="timeCode" style="text-transform:uppercase" value="<?php echo @$items->timeCode; ?>">
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_TimeName" class="col-sm-3 col-form-label"><?php echo @lang('TIME_NAME'); ?></label>
    ...
    <div class="mb-2 row">
      <label for="_Description" class="col-sm-3 col-form-label"><?php echo @lang('DESCRIPTION'); ?></label>
      <div class="col-sm-4 has-validation">
