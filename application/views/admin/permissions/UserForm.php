...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-2 row">
      <label for="_UserName" class="col-sm-3 col-form-label"><?php echo @lang('USER_NAME'); ?></label>
    ...
    <div class="mb-2 row">
      <label for="_FirstName" class="col-sm-3 col-form-label"><?php echo @lang('FIRST_NAME'); ?></label>
      <div class="col-sm-4 has-validation">
        <input type="text" class="form-control" id="_FirstName" name="firstName" value="<?php echo @$items->firstName; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_LastName" class="col-sm-3 col-form-label"><?php echo @lang('LAST_NAME'); ?></label>
      <div class="col-sm-4 has-validation">
        <input type="text" class="form-control" id="_LastName" name="lastName" value="<?php echo @$items->lastName; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_RoleCode" class="col-sm-3 col-form-label"><?php echo @lang('ROLE_ID'); ?></label>
      <div class="col-sm-4 has-validation">
        <?php echo @$selectBoxRoleId; ?>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_EffectiveStartDate" class="col-sm-3 col-form-label"><?php echo @lang('EFFECTIVE_START_DATE'); ?></label>
    ...
    <div class="mb-2 row">
      <label for="_EffectiveEndDate" class="col-sm-3 col-form-label"><?php echo @lang('EFFECTIVE_END_DATE'); ?></label>
      <div class="col-sm-2 has-validation">
