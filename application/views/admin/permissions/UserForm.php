...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-2 row">
      <label for="_UserName" class="col-md-3 col-form-label"><?php echo @lang('USER_NAME'); ?></label>
      <div class="col-md-4 has-validation">
        <input type="email" class="form-control" id="_UserName" name="userName" value="<?php echo @$items->userName; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_FirstName" class="col-md-3 col-form-label"><?php echo @lang('FIRST_NAME'); ?></label>
      <div class="col-md-4 has-validation">
        <input type="text" class="form-control" id="_FirstName" name="firstName" value="<?php echo @$items->firstName; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_LastName" class="col-md-3 col-form-label"><?php echo @lang('LAST_NAME'); ?></label>
      <div class="col-md-4 has-validation">
        <input type="text" class="form-control" id="_LastName" name="lastName" value="<?php echo @$items->lastName; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_RoleCode" class="col-md-3 col-form-label"><?php echo @lang('ROLE_ID'); ?></label>
      <div class="col-md-4 has-validation">
        <?php echo @$selectBoxRoleId; ?>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_EffectiveStartDate" class="col-md-3 col-form-label"><?php echo @lang('EFFECTIVE_START_DATE'); ?></label>
      <div class="col-md-2 has-validation">
        <input type="text" class="form-control" id="_EffectiveStartDate" name="effectiveStartDate" placeholder="dd/mm/yyyy" value="<?php echo @$items->effectiveStartDateDmy; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_EffectiveEndDate" class="col-md-3 col-form-label"><?php echo @lang('EFFECTIVE_END_DATE'); ?></label>
      <div class="col-md-2 has-validation">
        <input type="text" class="form-control" id="_EffectiveEndDate" name="effectiveEndDate" placeholder="dd/mm/yyyy" value="<?php echo @$items->effectiveEndDateDmy; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
...
<script>
  $(document).ready(function() {
    ...
    $('#_EffectiveStartDate').datepicker({
      format: "dd/mm/yyyy",
      clearBtn: true,
      // language: "th",
      todayHighlight: true
    ...
    var baseUrl = "<?php echo base_url(); ?>page/user";
    ...
    $("#_UserName").keyup(function() {
      ...
      let validateUrl = `${baseUrl}/validate/${formId}/${userName}`;
...
<script src="<?php echo base_url(); ?>public/datepicker/locales/bootstrap-datepicker.th.min.js" charset="UTF-8"></script>