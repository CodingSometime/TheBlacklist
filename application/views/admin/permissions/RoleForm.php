  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-2 row">
      ...
      <div class="col-sm-2 has-validation">
        <input type="text" class="form-control" id="_RoleCode" name="roleCode" style="text-transform:uppercase" value="<?php echo @$items->roleCode; ?>" required>
      </div>
    </div>
    <div class="mb-2 row">
      <label for="_RoleName" class="col-sm-3 col-form-label"><?php echo @lang('ROLE_NAME'); ?></label>
