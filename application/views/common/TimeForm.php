...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-3 row">
    <label for="validTimeCode" class="col-sm-3 col-form-label"><?php echo @lang('TIME_CODE');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validTimeCode" name="timeCode" value="<?php echo @$items->timeCode; ?>" >
      <div class="invalid-feedback"><?php echo @lang('TIME_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validTimeName" class="col-sm-3 col-form-label"><?php echo @lang('TIME_NAME');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validTimeName" name="timeName" value="<?php echo @$items->timeName; ?>" >
      <div class="invalid-feedback"><?php echo @lang('TIME_NAME');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validDescription" class="col-sm-3 col-form-label"><?php echo @lang('DESCRIPTION');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validDescription" name="description" value="<?php echo @$items->description; ?>" >
      <div class="invalid-feedback"><?php echo @lang('DESCRIPTION');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/time";
  }
