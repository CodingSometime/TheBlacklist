...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validCompanyCode" name="companyCode" value="<?php echo @$items->companyCode; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('COMPANY_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validCompanyName" class="col-sm-3 col-form-label"><?php echo @lang('COMPANY_NAME');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validCompanyName" name="companyName" value="<?php echo @$items->companyName; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('COMPANY_NAME');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validDescriptionEn" class="col-sm-3 col-form-label"><?php echo @lang('DESCRIPTION_EN');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validDescriptionEn" name="descriptionEn" value="<?php echo @$items->descriptionEn; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('DESCRIPTION_EN');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validDescriptionTh" class="col-sm-3 col-form-label"><?php echo @lang('DESCRIPTION_TH');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validDescriptionTh" name="descriptionTh" value="<?php echo @$items->descriptionTh; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('DESCRIPTION_TH');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/company";
  }
