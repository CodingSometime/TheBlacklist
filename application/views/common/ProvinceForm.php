...
<div class="col-md-5">
  <label for="validationprovinceCode" class="form-label">Province Code</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationprovinceCode" name="provinceCode" value="<?php echo @$items->provinceCode; ?>" required />
    <div class="invalid-feedback">Please enter a valid Province Code.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
  <label for="validationprovinceName" class="form-label">Province Name</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationprovinceName" name="provinceName" value="<?php echo @$items->provinceName; ?>" required />
    <div class="invalid-feedback">Please enter a valid Province Name.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
  <label for="validationcountryCode" class="form-label">Country Code</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationcountryCode" name="countryCode" value="<?php echo @$items->countryCode; ?>" required />
    <div class="invalid-feedback">Please enter a valid Country Code.</div>
  </div>
  </div>
</div>
    <div class="row pt-2 pb-2">
