...
<div class="col-md-5">
  <label for="validationstatusCode" class="form-label">Status Code</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationstatusCode" name="statusCode" value="<?php echo @$items->statusCode; ?>" required />
    <div class="invalid-feedback">Please enter a valid Status Code.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
  <label for="validationstatusName" class="form-label">Status Name</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationstatusName" name="statusName" value="<?php echo @$items->statusName; ?>" required />
    <div class="invalid-feedback">Please enter a valid Status Name.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
