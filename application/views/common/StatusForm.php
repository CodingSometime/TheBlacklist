...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    <?php echo form_open(base_url() . "page/status/save", array("id" => "formData", "class" => "row g-3 needs-validation")); ?>
    ...
    <div class="mb-3 row">
    <label for="validStatusCode" class="col-sm-3 col-form-label"><?php echo @lang('STATUS_CODE');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validStatusCode" name="statusCode" value="<?php echo @$items->statusCode; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('STATUS_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validStatusNameEn" class="col-sm-3 col-form-label"><?php echo @lang('STATUS_NAME_EN');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validStatusNameEn" name="statusNameEn" value="<?php echo @$items->statusNameEn; ?>" >
      <div class="invalid-feedback"><?php echo @lang('STATUS_NAME_EN');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validStatusNameTh" class="col-sm-3 col-form-label"><?php echo @lang('STATUS_NAME_TH');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validStatusNameTh" name="statusNameTh" value="<?php echo @$items->statusNameTh; ?>" >
      <div class="invalid-feedback"><?php echo @lang('STATUS_NAME_TH');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/status";
  }
