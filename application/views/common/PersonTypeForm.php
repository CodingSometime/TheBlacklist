...
<div class="col-md-5">
  <label for="validationpersonTypeName" class="form-label">Person Type Name</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationpersonTypeName" name="personTypeName" value="<?php echo @$items->personTypeName; ?>" required />
    <div class="invalid-feedback">Please enter a valid Person Type Name.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
