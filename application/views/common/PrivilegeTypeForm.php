...
<div class="col-md-5">
  <label for="validationprivilegeTypeName" class="form-label">Privilege Type Name</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationprivilegeTypeName" name="privilegeTypeName" value="<?php echo @$items->privilegeTypeName; ?>" required />
    <div class="invalid-feedback">Please enter a valid Privilege Type Name.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
