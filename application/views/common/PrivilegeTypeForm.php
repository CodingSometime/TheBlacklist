...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-3 row">
    <label for="validPrivilegeTypeCode" class="col-sm-3 col-form-label"><?php echo @lang('PRIVILEGE_TYPE_CODE');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validPrivilegeTypeCode" name="privilegeTypeCode" value="<?php echo @$items->privilegeTypeCode; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('PRIVILEGE_TYPE_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validPrivilegeTypeName" class="col-sm-3 col-form-label"><?php echo @lang('PRIVILEGE_TYPE_NAME');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validPrivilegeTypeName" name="privilegeTypeName" value="<?php echo @$items->privilegeTypeName; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('PRIVILEGE_TYPE_NAME');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/privilege-type";
  }
