...
<div class="col-md-5">
  <label for="validationroleName" class="form-label">Role Name</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationroleName" name="roleName" value="<?php echo @$items->roleName; ?>" required />
