...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validRoleCode" name="roleCode" value="<?php echo @$items->roleCode; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('ROLE_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validRoleName" class="col-sm-3 col-form-label"><?php echo @lang('ROLE_NAME');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validRoleName" name="roleName" value="<?php echo @$items->roleName; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('ROLE_NAME');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/role";
  }
