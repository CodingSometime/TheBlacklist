<div class="d-flex justify-content-between align-items-center mt-3">
  ...
  <a href="<?php echo base_url(); ?>page/user/create" class="btn btn-primary"><i class="ti ti-plus icon"></i> New <?php echo @lang("TITLE"); ?></a>
</div>
        ...
        ?>
            <tr>
              <td class="text-muted"><?php echo $counter; ?></td>
							...
							<td><?php echo @$rs->effectiveStartDate;?></td>
							<td><?php echo @$rs->effectiveEndDate;?></td>
