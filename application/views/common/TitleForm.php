...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    <?php echo form_open(base_url() . "page/title/save", array("id" => "formData", "class" => "row g-3 needs-validation")); ?>
    ...
    <div class="mb-3 row">
    <label for="validTitleCode" class="col-sm-3 col-form-label"><?php echo @lang('TITLE_CODE');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validTitleCode" name="titleCode" value="<?php echo @$items->titleCode; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('TITLE_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validTitleName" class="col-sm-3 col-form-label"><?php echo @lang('TITLE_NAME');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validTitleName" name="titleName" value="<?php echo @$items->titleName; ?>" >
      <div class="invalid-feedback"><?php echo @lang('TITLE_NAME');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/title";
  }
