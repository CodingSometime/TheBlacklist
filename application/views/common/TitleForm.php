...
<div class="col-md-5">
  <label for="validationtitleCode" class="form-label">Title Code</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationtitleCode" name="titleCode" value="<?php echo @$items->titleCode; ?>" required />
    <div class="invalid-feedback">Please enter a valid Title Code.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
  <label for="validationtitleName" class="form-label">Title Name</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationtitleName" name="titleName" value="<?php echo @$items->titleName; ?>" required />
    <div class="invalid-feedback">Please enter a valid Title Name.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
