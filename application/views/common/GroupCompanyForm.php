...
<div class="col-md-5">
  <label for="validationgroupOfCompany" class="form-label">Group Of Company</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationgroupOfCompany" name="groupOfCompany" value="<?php echo @$items->groupOfCompany; ?>" required />
    <div class="invalid-feedback">Please enter a valid Group Of Company.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
