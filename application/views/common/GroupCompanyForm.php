...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    <?php echo form_open(base_url() . "page/group-company/save", array("id" => "formData", "class" => "row g-3 needs-validation")); ?>
    ...
    <div class="mb-3 row">
    <label for="validGroupCode" class="col-sm-3 col-form-label"><?php echo @lang('GROUP_CODE');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validGroupCode" name="groupCompanyCode" value="<?php echo @$items->groupCompanyCode; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('GROUP_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validGroupName" class="col-sm-3 col-form-label"><?php echo @lang('GROUP_NAME');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validGroupName" name="groupOfCompany" value="<?php echo @$items->groupOfCompany; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('GROUP_NAME');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/group-company";
  }
