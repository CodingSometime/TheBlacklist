<div class="shadow bg-body">
    ...
    <table class="table">
      <thead>
        <tr>
			...
			<th><?php echo @lang("BU_CODE");?></th>
			<th><?php echo @lang("BU_NAME");?></th>
			<th><?php echo @lang("GROUP_COMPANY_CODE");?></th>
  ...
  <tr>
			...
			<td><?php echo @$rs->buCode;?></td>
			<td><?php echo @$rs->buName;?></td>
			<td><?php echo @$rs->groupCompanyCode;?></td>
...
<script>
  ...
  function btnDeleteClick(id, label) {
    $(document).ready(function() {
      $("#modalMessage").html(`Are you sure you want to delete business-unit "${label}" ?`);
