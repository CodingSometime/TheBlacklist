<div class="d-flex justify-content-between align-items-center mt-3">
  ...
  <a href="<?php echo base_url(); ?>page/company/create" class="btn btn-primary"><i class="ti ti-plus icon"></i> New <?php echo @lang("TITLE"); ?></a>
</div>
      ...
      <thead>
        <tr>
          <th>#</th>
					...
					<th><?php echo @lang("DESCRIPTION_EN");?></th>
					<th><?php echo @lang("DESCRIPTION_TH");?></th>
