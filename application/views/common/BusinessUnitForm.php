...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validBusinessUnitCode" name="businessUnitCode" value="<?php echo @$items->businessUnitCode; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('BUSINESS_UNIT_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validBusinessUnitName" class="col-sm-3 col-form-label"><?php echo @lang('BUSINESS_UNIT_NAME');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validBusinessUnitName" name="businessUnitName" value="<?php echo @$items->businessUnitName; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('BUSINESS_UNIT_NAME');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validGroupCompanyId" class="col-sm-3 col-form-label"><?php echo @lang('GROUP_COMPANY_ID');?></label>
    <div class="col-sm-4 has-validation">
    <?php echo @$selectBoxGroupCompanyId;?>
      <div class="invalid-feedback"><?php echo @lang('GROUP_COMPANY_ID');?> <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/business-unit";
  }
