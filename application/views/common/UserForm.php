...
<div class="col-md-5">
  ...
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationuserName" name="userName" value="<?php echo @$items->userName; ?>" required />
...
<div class="col-md-5">
  ...
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationfirstName" name="firstName" value="<?php echo @$items->firstName; ?>" required />
...
<div class="col-md-5">
  ...
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationlastName" name="lastName" value="<?php echo @$items->lastName; ?>" required />
