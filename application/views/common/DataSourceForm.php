...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="mb-3 row">
    <label for="validCode" class="col-sm-3 col-form-label"><?php echo @lang('CODE');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validCode" name="code" value="<?php echo @$items->code; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validName" class="col-sm-3 col-form-label"><?php echo @lang('NAME');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validName" name="name" value="<?php echo @$items->name; ?>" >
      <div class="invalid-feedback"><?php echo @lang('NAME');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/data-source";
  }
