...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    <?php echo form_open(base_url() . "page/district/save", array("id" => "formData", "class" => "row g-3 needs-validation")); ?>
    ...
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validProvinceId" name="provinceId" value="<?php echo @$items->provinceId; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('PROVINCE_ID');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validDistrictCode" class="col-sm-3 col-form-label"><?php echo @lang('DISTRICT_CODE');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validDistrictCode" name="districtCode" value="<?php echo @$items->districtCode; ?>" >
      <div class="invalid-feedback"><?php echo @lang('DISTRICT_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validDistrictName" class="col-sm-3 col-form-label"><?php echo @lang('DISTRICT_NAME');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validDistrictName" name="districtName" value="<?php echo @$items->districtName; ?>" >
      <div class="invalid-feedback"><?php echo @lang('DISTRICT_NAME');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/district";
  }
