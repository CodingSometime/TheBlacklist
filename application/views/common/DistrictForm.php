...
<div class="col-md-5">
  <label for="validationprovinceId" class="form-label">Province Id</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationprovinceId" name="provinceId" value="<?php echo @$items->provinceId; ?>" required />
    <div class="invalid-feedback">Please enter a valid Province Id.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
  <label for="validationdistrictCode" class="form-label">District Code</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationdistrictCode" name="districtCode" value="<?php echo @$items->districtCode; ?>" required />
    <div class="invalid-feedback">Please enter a valid District Code.</div>
  </div>
  </div>
</div><div class="row pt-2 pb-2">
<div class="col-md-5">
  <label for="validationdistrictName" class="form-label">District Name</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationdistrictName" name="districtName" value="<?php echo @$items->districtName; ?>" required />
