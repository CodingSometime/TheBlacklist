...
<div class="col-md-5">
  <label for="validationcountryName" class="form-label">Country Name</label>
  <div class="input-group has-validation">
    <input type="text" class="form-control" id="validationcountryName" name="countryName" value="<?php echo @$items->countryName; ?>" required />
