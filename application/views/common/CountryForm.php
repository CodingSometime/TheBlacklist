...
<div class="my-1 p-3 rounded shadow bg-body">
  ...
  <div class="my-1 p-3 rounded">
    ...
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validCountryCode" name="countryCode" value="<?php echo @$items->countryCode; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('COUNTRY_CODE');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validCountryNameEn" class="col-sm-3 col-form-label"><?php echo @lang('COUNTRY_NAME_EN');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validCountryNameEn" name="countryNameEn" value="<?php echo @$items->countryNameEn; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('COUNTRY_NAME_EN');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
    <label for="validCountryNameTh" class="col-sm-3 col-form-label"><?php echo @lang('COUNTRY_NAME_TH');?></label>
    <div class="col-sm-4 has-validation">
      <input type="text" class="form-control" id="validCountryNameTh" name="countryNameTh" value="<?php echo @$items->countryNameTh; ?>" required>
      <div class="invalid-feedback"><?php echo @lang('COUNTRY_NAME_TH');?>  <?php echo @lang('FORM_VALIDATE_REQUIRE');?></div>
    </div>
</div><div class="mb-3 row">
...
<script>
  function btnCancelClick(myForm) {
    ...
    window.location= "<?php echo base_url(); ?>page/country";
  }
