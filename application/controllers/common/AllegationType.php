...
class AllegationType extends BaseController
{
  ...
  private $title = "AllegationType";
  private $route = "page/allegation-type";
  private $model_name = "AllegationTypeModel";
  private $view_list = "common/AllegationTypeList";
  private $view_form = "common/AllegationTypeForm";

  // formatting breadcrumbs
  private $breadcrumbs = array(
    array("Home" => "#"),
    array("Allegation Type" => null)
  );
  ...
  function __construct()
  {
    ...
    // load language
    $this->lang->load("AllegationType", "english");
    // load models
