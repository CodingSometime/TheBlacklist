...
class PrivilegeType extends BaseController
{
  ...
  private $title = "PrivilegeType";
  private $route = "page/privilege-type";
  private $model_name = "PrivilegeTypeModel";
  private $view_list = "common/PrivilegeTypeList";
  private $view_form = "common/PrivilegeTypeForm";

  // formatting breadcrumbs
  private $breadcrumbs = array(
    array("Home" => "#"),
    array("Privilege Type" => null)
  );
  ...
  function __construct()
  {
    ...
    // load language
    $this->lang->load("PrivilegeType", "english");
    // load models
