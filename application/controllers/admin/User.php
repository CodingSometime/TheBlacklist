...
class User extends BaseController
{
  ...
  private $view_list = "admin/permissions/UserList";
  private $view_form = "admin/permissions/UserForm";
  ...
  public function save()
  {
    ...
    // formatting date from thai to standard date format
    $forms["effectiveStartDate"] = $this->dateFormat($forms["effectiveStartDate"]);
    $forms["effectiveEndDate"] = $this->dateFormat($forms["effectiveEndDate"]);
  ...
  // route: /page/user/validate/(:id)/(:userName)
  // method: GET
  public function validate($id, $userName)
  {
    // is duplicate ? then return json for javascript validation
    if ($this->BaseModel->isDuplicate($id, $userName)) {
