...
{
  private $route = "page/title";
  private $language = "Title";
  private $view_list = "admin/foundations/TitleList";
  private $view_form = "admin/foundations/TitleForm";
  ...
  function __construct()
  {
    ...
    // load models
    $this->load->model("TitleModel", "BaseModel");
  ...
  public function index()
  {
    ...
    if (isset($_GET["q"]) && !empty($_GET["q"])){
			$conditions["TITLE_CODE"] = $_GET["q"];
			$conditions["TITLE_NAME"] = $_GET["q"];
    }
  ...
  private function view($action, $id = null)
  {
    ...
    if (isset($id)) {
      ...
      $items["items"] = $object;
      $displayValue = @$object->titleCode . " : " . @$object->titleName;
  ...
  // route: /page/title/validate/(:id)/(:titleCode)
  // method: GET
  public function validate($id, $titleCode)
  {
    // is duplicate ? then return json for javascript validation
    if ($this->BaseModel->isDuplicate($id, $titleCode)) {
