...
class PersonType extends BaseController
{
  private $route = "page/person-type";
  private $language = "PersonType";
  private $view_list = "admin/foundations/PersonTypeList";
  private $view_form = "admin/foundations/PersonTypeForm";

  // formatting breadcrumbs
  private $breadcrumbs = array(
    array("" => null),
    array("ROOT" => null),
    array("TITLE" => "/page/person-type")
  );
  ...
  function __construct()
  {
    ...
    // load models
    $this->load->model("PersonTypeModel", "BaseModel");
		$this->load->model("StatusModel");
  }

  // home page / index page
  // route: /page/person-type
  // method: GET
  public function index()
  {
    ...
    if (isset($_GET["q"]) && !empty($_GET["q"])){
			...
			$conditions["PERSON_TYPE_NAME"] = $_GET["q"];
    }
  ...
  private function view($action, $id = null)
  {
    ...
    if (isset($id)) {
      ...
      $items["items"] = $object;
      $displayValue = @$object->personTypeCode . " : " . @$object->personTypeName;
  ...
  // route: /page/person-type/edit/(:num)
  // method: GET
  ...
  // route: /page/person-type/delete/(:num)
  // method: GET
  ...
  // route: /page/person-type/save/(:num)
  // method: POST
  ...
  // route: /page/person-type/insert/(:num)
  // method: POST
  ...
  // route: /page/person-type/update/(:num)
  // method: POST
  ...
  // route: /page/person-type/remove/(:num)
  // method: POST
  ...
  // route: /page/person-type/validate/(:id)/(:personTypeCode)
  // method: GET
  public function validate($id, $personTypeCode)
  {
    // is duplicate ? then return json for javascript validation
    if ($this->BaseModel->isDuplicate($id, $personTypeCode)) {
