...
{
  private $route = "page/district";
  private $language = "District";
  private $view_list = "admin/foundations/DistrictList";
  private $view_form = "admin/foundations/DistrictForm";

  // formatting breadcrumbs
  private $breadcrumbs = array(
    array("" => null),
    array("ROOT" => null),
    array("TITLE" => "/page/district")
  );
  ...
  function __construct()
  {
    ...
    // load models
    $this->load->model("DistrictModel", "BaseModel");
  ...
  // route: /page/district/delete/(:num)
  // method: GET
  ...
  // route: /page/district/insert/(:num)
  // method: POST
  ...
  // route: /page/district/update/(:num)
  // method: POST
  ...
  // route: /page/district/remove/(:num)
  // method: POST
  ...
  // route: /page/district/validate/(:id)/(:districtCode)
  // method: GET
  public function validate($id, $districtCode)
  {
    // is duplicate ? then return json for javascript validation
    if ($this->BaseModel->isDuplicate($id, $districtCode)) {
