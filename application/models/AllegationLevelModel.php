...
class AllegationLevelModel extends BaseModel
{
	protected $tableName = "FND_ALLEGATION_LEVEL";
	protected $viewName = "FND_ALLEGATION_LEVEL";
  protected $primaryKey = "ID";
	...
	public function selectBox($controlName=null, $selected = null, $hasAll = false, $isRequired = true, $isReadOnly = false)
	{
		...
		$this->db->select("ID AS OPTION_VALUE, LEVEL_NAME AS OPTION_NAME", false);
	...
	public function isDuplicate($id, $allegationCode)
	{
		...
		$this->db->where("LEVEL_CODE", $allegationCode);
